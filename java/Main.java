...
public class Main {
    public static void main(String[] args) {
        ...
        ArrayList <Employee> employees = EmployeeReader.loadEmployees();
        ...
        ArrayList<Model> models = ModelReader.loadModels();
        
        System.out.println("Models loaded from CSV:");
        ...
        ArrayList<Attendance> records = AttendanceReader.loadAttendance();
        
        System.out.println("Attendance records loaded from CSV:");
        ...
        System.out.println("Sales loaded from CSV: ");
        for (Sale sale : sales){
